...
a.print: if user enter print then it should print all countries with their 
population in this format,
china==>143
india==>136
usa==>32
pakistan==>21
b.add: if user input add then it should further ask for a country name to add. If country 
...
c.remove: when user inputs remove it should ask for a country to remove. If country exist 
